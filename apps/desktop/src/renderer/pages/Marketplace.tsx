...
const DEMO_EXTENSIONS: MarketplaceExtension[] = [
  ...
  { id: 'ext-social-auto-poster', name: 'social-auto-poster', displayName: 'Social Auto Poster', description: 'Lên lịch & tự động đăng bài Facebook / YouTube / TikTok qua Auto-Post Tool (backend izzi thống nhất). Cài xong agent gọi trực tiếp — dùng chung tài khoản izzi.', author: 'Starizzi', version: '0.2.0', category: 'Marketing', rating: 4.5, installs: 8900, price: { monthly: 9.99, yearly: 99.99 }, icon: '📱' },

...
const DEMO_EXTENSIONS: MarketplaceExtension[] = [
  ...
  { id: 'ext-fb-ads', name: 'fb-ads-manager', displayName: 'FB Ads Manager', description: 'Tạo & quản lý chiến dịch Facebook/Meta Ads qua Graph API (Campaign → Ad Set → Ad). Có sẵn MCP cho agent.', author: 'Starizzi', version: '1.0.0', category: 'Marketing', rating: 4.4, installs: 2600, price: { monthly: 14.99, yearly: 149 }, icon: '📣' },
